...
[_BASE] = LAYOUT_split_3x6_3(
  KC_HEART , KC_Q         , KC_W         , KC_F               , KC_P         , KC_B             ,     KC_J             , KC_L              , KC_U             , KC_Y           , XXX          , XXX    ,
...
[_SYM] = LAYOUT_split_3x6_3(
  KC_GRAVE , KC_EXCLAIM    , KC_LT       , KC_GT      , KC_HASH     , KC_PERCENT    ,     KC_AMPERSAND , KC_LEFT_CURLY_BRACE , KC_RIGHT_CURLY_BRACE , KC_QUOTE        , XXX      , XXX,
  XXX      , KC_UNDERSCORE , KC_KP_MINUS , KC_KP_PLUS , KC_KP_EQUAL , KC_CIRCUMFLEX ,     KC_DOLLAR    , KC_LEFT_PAREN       , KC_RIGHT_PAREN       , KC_DOUBLE_QUOTE , KC_GRAVE , XXX,
  XXX      , XXX           , KC_TILDE    , KC_SLASH   , KC_ASTERISK , KC_BACKSLASH  ,     KC_PIPE      , KC_LEFT_BRACKET     , KC_RIGHT_BRACKET     , KC_AT           , XXX      , XXX,
                                                                                                                                                                                         ,
                                           XXX        , XXX         , XXX           ,     XXX          , XXX                 , XXX
),
...
[_NUM] = LAYOUT_split_3x6_3(
  XXX , XXX  , XXX  , XXX  , KC_0   , KC_KP_PLUS ,     KC_KP_MINUS , XXX  , XXX  , XXX  , XXX , XXX,
  XXX , KC_1 , KC_2 , KC_3 , KC_4   , KC_5       ,     KC_6        , KC_7 , KC_8 , KC_9 , XXX , XXX,
  XXX , XXX  , XXX  , XXX  , XXX    , XXX        ,     XXX         , XXX  , XXX  , XXX  , XXX , XXX,
                                                                                                      ,
                      XXX  , KC_DOT , KC_SPC     ,     XXX         , XXX  , XXX
),
...
[_FUN] = LAYOUT_split_3x6_3(
  XXX , XXX   , XXX   , XXX   , XXX    , XXX    ,     XXX    , XXX   , XXX   , XXX   , XXX   , XXX,
  XXX , KC_F1 , KC_F2 , KC_F3 , KC_F4  , KC_F5  ,     KC_F5  , KC_F6 , KC_F7 , KC_F8 , KC_F9 , XXX,
  XXX , XXX   , XXX   , XXX   , KC_F10 , KC_F11 ,     KC_F12 , XXX   , XXX   , XXX   , XXX   , XXX,
                                                                                                     ,
                        XXX   , XXX    , XXX    ,     XXX    , XXX   , XXX
)
};
